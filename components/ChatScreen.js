...
export default function ChatScreen( {navigation} ) {
    var convos = [
        { key: 1, pic: require('../assets/huey-kent.png'), name: "Mira Kent", lastMessage: {text: "Sounds like a plan!", timestamp: new Date(Date.now() - 600000)}, read: false},
        { key: 2, pic: require('../assets/faouzia.jpg'), name: "Faouzia Ouihya", lastMessage: {text: "OMG I think I just figured it out!", timestamp: new Date(Date.now() - 6000000)}, read: false},
        { key: 3, pic: require('../assets/finn.jpg'), name: "Finn Walker", lastMessage: {text: "Lecture was so entertaining today", timestamp: new Date(Date.now() - 60000000)}, read: false},
        { key: 4, pic: require('../assets/brig.jpg'), name: "Brig Lundy-Paine", lastMessage: {text: "Wow great job!", timestamp: new Date(Date.now() - 6000000000)}, read: true}
      ];
